function [u] = manySpringsFixF2(k, m, dt, nt, u10, un0, nmasses, force_fn, f_boundary)
...
for ii=2:nt-1
    ...
    u(ii+1,nmasses) = (k/m)*dt^2*(u(ii,nmasses-1)-u(ii,nmasses))+2*u(ii,nmasses)-u(ii-1,nmasses)+(1/m)*f_boundary(ii,1)*dt^2;
end
